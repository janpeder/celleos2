...
\smallskip
\hbox to \tocwidth{2.1. Klargj\o re minnepinne for installasjon \dotfill 4}
%\hbox to \tocwidth{2.X. Bakgrunn om UEFI og BIOS \dotfill 6}
\hbox to \tocwidth{2.2. Klargj\o ring av datamaskin f\o r installasjon \dotfill 6}
\hbox to \tocwidth{2.3. Installasjon \dotfill 7}
\medskip
...
\smallskip
\noindent {\tt https://github.com/janpeder/celleos2}
...
CelleOS installeres ved at man f\o rst laster ned en {\it avbildingsfil} og skriver denne til en minnepinn. Deretter installerer man CelleOS ved hjelp av minnepinnen. Her f\o lger en detaljert beskrivelse av hvordan dette gj\o res.

\beginsection{\fss 2.1. Klargj\o re minnepinne for installasjon}

For \aa{} lage installasjonsminnepinnen trenger du en minnepinne med minimum 8GB kapasitet og en datamaskin med internettforbindelse. Alt p\aa{} minnepinnen vil bli overskrevet, s\aa{} s\o rg for \aa{} ta kopi av alt du vil ta vare p\aa{} f\o r du begynner. Se instruksjon nedenfor.
...
\vskip 1.5pc
\item{3.} Koble minnepinnen du vil bruke til PCens USB-kontakt. {\it (Husk at alt p\aa{} minnepinnen vil bli overskrevet.)}
...
\vskip 1.5pc
\item{5.} I vinduet velger du hvilken USB-enhet du vil skrive avbildings\-filen til. S\aa{} velger du at avbildings\-filen du lastet ned er den som skal skrives til minnepinnen. Til slutt trykker du p\aa{} ``Start''.
...
\beginsection{\fss 2.2. Klargj\o ring av datamaskin f\o r installasjon}
...
TODO: FÅ INN HER AT SECURE BOOT MÅ VÆRE SKRUDD AV  I BIOS/UEFI INNSTILLINGER.
...
\beginsection{\fss 2.3. Installasjon}
